test_that("sinan-malaria-final at 2016", {
  sinan_malaria_final <- fetch_datasus(year_start = 2016, year_end = 2016, information_system = "SINAN-MALARIA-FINAL")
...
test_that("sinan-malaria-preliminar at 2020", {
  sinan_malaria_preliminar <- fetch_datasus(year_start = 2020, year_end = 2020, information_system = "SINAN-MALARIA-PRELIMINAR")
