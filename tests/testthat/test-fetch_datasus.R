...
test_that("fetch sinan chikungunya", {
  skip()
  sinan_chikungunya_raw <- fetch_datasus(
    year_start = 2022,
    year_end = 2022,
...
test_that("fetch sinan malaria", {
  skip()
  sinan_malaria_raw <- fetch_datasus(
    year_start = 2016,
    year_end = 2016,
...
test_that("fetch sinan chagas", {
  skip()
  sinan_chagas_raw <- fetch_datasus(
    year_start = 2023,
    year_end = 2023,
