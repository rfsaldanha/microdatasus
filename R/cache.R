...
#'
#' Returns a platform-appropriate directory that users may pass to `cache_dir`
#' or set in `options(microdatasus.cache_dir = ...)`. Calling this function,
#' even with `create = TRUE`, does not change that option or enable persistent
#' caching for subsequent downloads or processing calls.
#'
