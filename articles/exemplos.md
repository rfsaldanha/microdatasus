# Primeiros passos e exemplos por sistema
...
territorial adequada à pergunta de pesquisa. O livro [*Sistemas de
Informação em Saúde no Brasil*](https://rfsaldanha.github.io/sis/)
apresenta a unidade de análise, a cobertura, os fluxos e os cuidados de
cada sistema.

## SIM — mortalidade

O Sistema de Informação sobre Mortalidade registra óbitos e tem como
documento básico a Declaração de Óbito. O [capítulo sobre o
SIM](https://rfsaldanha.github.io/sis/sim.html) discute, entre outros
temas, causa básica, causas múltiplas, residência, ocorrência e análise
temporal.
...
O SINASC registra nascidos vivos a partir da Declaração de Nascido Vivo.
Veja o [capítulo sobre o
SINASC](https://rfsaldanha.github.io/sis/sinasc.html) para conhecer seu
fluxo, cobertura e cuidados analíticos.
...
O SIH registra internações financiadas pelo SUS por meio da Autorização
de Internação Hospitalar. O [capítulo sobre o
SIH](https://rfsaldanha.github.io/sis/sih.html) detalha a AIH, a unidade
de análise e os limites de interpretação da produção hospitalar.
...
O SIA reúne diferentes instrumentos e layouts da produção ambulatorial
do SUS. O [capítulo sobre o
SIA](https://rfsaldanha.github.io/sis/sia.html) ajuda a escolher o
arquivo apropriado e a interpretar procedimentos, produção e
instrumentos de registro.

O exemplo abaixo baixa a produção individualizada `SIA-PA` de dois
meses:
...
durante o mês. O [capítulo sobre o
...
ignorado, e a seleção territorial deve ser feita depois do download
usando as variáveis adequadas. Consulte o [capítulo sobre o
...
- Veja [Download e
  ...
  para múltiplas UFs, `vars`, `track_source`, timeouts e falhas
  parciais.
- Consulte as [Perguntas
  frequentes](https://rfsaldanha.github.io/microdatasus/articles/FAQ.md)
  para períodos, tipos de retorno, memória, bancos de dados e arquivos
  DBC locais.
